// Next.js SSE proxy for POST /api/chat/resume → FastAPI POST /chat/resume.
//
// Identical SSE passthrough pattern to /api/chat — remaining graph nodes
// emit status events after a PalAssist interrupt is resolved.
//
...
export async function POST(request: NextRequest) {
  ...
  try {
    backendResponse = await fetch(`${backendUrl}/chat/resume`, {
      method: "POST",
